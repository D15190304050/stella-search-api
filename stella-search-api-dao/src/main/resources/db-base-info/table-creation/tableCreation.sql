...
(
    ...
    `creation_type`     INT                                                    NOT NULL COMMENT 'Creation type of the video: 0 - Original; 1 - Reprint.',
    `section_id`        INT                                                    NOT NULL COMMENT 'ID of the section that the video belongs to.',
    `labels`            VARCHAR(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin         DEFAULT NULL COMMENT 'Labels of the video, separated by ",", e.g., "Game,Challenge".',
